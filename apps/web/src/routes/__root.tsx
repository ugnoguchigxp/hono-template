...
import { chatSessionsRoute } from '../domain/chat/ChatSessionsRoute.js';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600 text-sm">Hono + TypeScript + Drizzle ORM + PostgreSQL</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-lg font-semibold mb-2">Frontend</h3>
          <p className="text-gray-600 text-sm">React + TanStack Query/Router + gxp-design-system</p>
        </div>
      </div>
    </div>
  ),
  ...
  component: () => (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <p className="text-gray-600 mb-6">Authentication features coming soon.</p>
